...
class RocketUI_authreq(QWidget):
    def __init__(self):
        import getpass
        import hashlib
        try:
            compare = int(hashlib.sha1(getpass.getpass("Enter password: ").encode("utf-8")).hexdigest(), 16)
            if compare != 1235226601229648840617131092404044671077623789963:
                print("Auth failed.")
                exit(0)
        except:
            print("Auth failed.")
        ...
        super().__init__()
        self.setWindowTitle("Complete Rocket Telemetry UI")
        ...
        self.polling = False
        self.apogeePyrosArmed = False
        self.BPWellsArmed = False
    ...
    def _build_ui(self):
        ...
        pyro_group = QGroupBox("Pyros and Servos Status")
        ...
        pyro_group2 = QGroupBox("Pyro Commands")
        pbtn_layout = QHBoxLayout()
        self.armApogeePyros_btn = QPushButton("Arm Apogee Pyros")
        self.armApogeePyros_btn.setStyleSheet("color: #FF00AA")
        self.armApogeePyros_btn.clicked.connect(self.armApogeePyros) # todo
        pbtn_layout.addWidget(self.armApogeePyros_btn)
        self.armBPWells_btn = QPushButton("Arm BP Wells")
        self.armBPWells_btn.setStyleSheet("color: #FF00AA")
        self.armBPWells_btn.clicked.connect(self.armBPWells) # todo
        pbtn_layout.addWidget(self.armBPWells_btn)
        pyro_group2.setLayout(pbtn_layout)
        p_layout.addWidget(pyro_group2)
        pyro_group3 = QGroupBox("")
        pbtn_layout2 = QHBoxLayout()
        self.fireApogeePyros_btn = QPushButton("FIRE Apogee Pyros")
        self.fireApogeePyros_btn.setStyleSheet("color: #888888")
        self.fireApogeePyros_btn.setEnabled(self.apogeePyrosArmed)
        self.fireApogeePyros_btn.clicked.connect(self.fireApogeePyros) # todo
        pbtn_layout2.addWidget(self.fireApogeePyros_btn)
        self.fireBPWells_btn = QPushButton("FIRE BP Wells")
        self.fireBPWells_btn.setStyleSheet("color: #888888")
        self.fireBPWells_btn.setEnabled(self.BPWellsArmed)
        self.fireBPWells_btn.clicked.connect(self.fireBPWells) # todo
        pbtn_layout2.addWidget(self.fireBPWells_btn)
        pyro_group3.setLayout(pbtn_layout2)
        p_layout.addWidget(pyro_group3)
    ...
    def armApogeePyros(self):
        print("<WARNING> Apogee Pryos Armed.")
        self.apogeePyrosArmed = not self.apogeePyrosArmed
        self.fireApogeePyros_btn.setEnabled(self.apogeePyrosArmed)
        self.armApogeePyros_btn.setText("DISARM Apogee Pyros" if self.apogeePyrosArmed else "ARM Apogee Pyros")
        self.fireApogeePyros_btn.setStyleSheet("color: " + ("#FF0022" if self.apogeePyrosArmed else "#888888"))

    def armBPWells(self):
        print("<WARNING> BP Wells Armed.")
        self.BPWellsArmed = not self.BPWellsArmed
        self.fireBPWells_btn.setEnabled(self.BPWellsArmed)
        self.armBPWells_btn.setText("DISARM BP Wells" if self.BPWellsArmed else "ARM BP Wells")
        self.fireBPWells_btn.setStyleSheet("color: " + ("#FF0022" if self.BPWellsArmed else "#888888"))

    def fireApogeePyros(self):
        print("Not implemented.")

    def fireBPWells(self):
        print("Not implemented.")
